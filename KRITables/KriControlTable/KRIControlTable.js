...
import { COLUMNS } from "./KRIControlColumn";
...
const KRIControlTable = ({ controlTableData }) => {
  ...
  const data = useMemo(() => controlTableData, []);
  ...
  return (
    <>
      <div>
        <p className='panel-heading'>Control Table</p>
      </div>
      <div>
        ...
        <span
          onClick={handleOpen}
          style={{ cursor: "pointer", marginLeft: "620px", fontSize: "14px" }}
      ...
      >
        <DialogContent>
          <div>
            <p className='panel-heading'>Show/Hide Columns : Control Table</p>
            <hr />
...
export default KRIControlTable;
